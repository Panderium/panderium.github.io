      ...
      <div class="tile is-parent">
        <div class="tile is-child">
          <div class="content is-medium">
            ...
            <h2 class="subtitle is-4">Étudiant-Ingénieur en informatique à Polytech Lyon</h2>
            <p>
              À 21 ans, je suis aujourd'hui étudiant en informatique. Passioné par les nouvelles technologies, j'aimerais
              une fois mon diplôme obtenu être plongé dans des projets mélant Smart Home, IoT et Intelligence Artificielle.
            </p>
            <p>
